...
prgm="MCP23017_GPIO_Keyb"
cahDir="/tmp/arduino_cache_294943_ykbd"
outDir="/tmp/arduino_build_294943_ykbd"
...
addLibs="-libraries ../../../libraries/"

#rm -rf $outDir && true 2>/dev/null 
#rm -rf $cahDir && true 2>/dev/null
mkdir $outDir 2>/dev/null

$ardDir/arduino-builder -compile -logger=machine -hardware $ardDir/hardware -hardware $homDir/.arduino15/packages -tools $ardDir/tools-builder -tools $ardDir/hardware/tools/avr -tools $homDir/.arduino15/packages -built-in-libraries $ardDir/libraries -libraries $homDir/Arduino/libraries $addLibs $FQBN -ide-version=10812 -build-path "$outDir" -warnings=none -build-cache "$cahDir" -prefs=build.warn_data_percentage=75 -prefs=runtime.tools.mkspiffs.path=$homDir/.arduino15/packages/esp32/tools/mkspiffs/0.2.3 -prefs=runtime.tools.mkspiffs-0.2.3.path=$homDir/.arduino15/packages/esp32/tools/mkspiffs/0.2.3 -prefs=runtime.tools.esptool_py.path=$homDir/.arduino15/packages/esp32/tools/esptool_py/2.6.1 -prefs=runtime.tools.esptool_py-2.6.1.path=$homDir/.arduino15/packages/esp32/tools/esptool_py/2.6.1 -prefs=runtime.tools.xtensa-esp32-elf-gcc.path=$homDir/.arduino15/packages/esp32/tools/xtensa-esp32-elf-gcc/1.22.0-80-g6c4433a-5.2.0 -prefs=runtime.tools.xtensa-esp32-elf-gcc-1.22.0-80-g6c4433a-5.2.0.path=$homDir/.arduino15/packages/esp32/tools/xtensa-esp32-elf-gcc/1.22.0-80-g6c4433a-5.2.0 $verbose ./$prgm.ino
